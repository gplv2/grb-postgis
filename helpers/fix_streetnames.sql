...
UPDATE planet_osm_polygon SET "addr:street"='Val des Épinettes - Doorndaal' , "addr:street:fr"='Val des Épinettes' WHERE "addr:street" = 'Val des Epinettes - Doorndal' AND "source:geometry:entity"='Urbis';
