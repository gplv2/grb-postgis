CREATE INDEX idx_tourism ON TABLE planet_osm_polygon ("tourism");
...
CREATE INDEX idx_hw ON planet_osm_polygom ("highway");
CREATE INDEX idx_hw ON planet_osm_polygon ("highway");
CREATE INDEX idx_name ON planet_osm_polygom ("name");
CREATE INDEX idx_name ON planet_osm_polygon ("name");
CREATE INDEX idx_name ON planet_osm_line ("name");
...
CREATE INDEX idx_leisure ON planet_osm_line ("leisure");
CREATE INDEX idx_point_place ON planet_osm_line ("pace");
CREATE INDEX idx_point_place ON planet_osm_line ("p;ace");
CREATE INDEX idx_point_place ON planet_osm_line ("place");
CREATE INDEX idx_point_name ON planet_osm_line ("name");
CREATE INDEX idx_join_poly ON planet_osm_polygon ("landuse","building","natura","waterway");
CREATE INDEX idx_join_poly ON planet_osm_polygon ("landuse","building","natural","waterway");
...
CREATE INDEX idx_mm ON planet_osm_polygon ("man_made");
