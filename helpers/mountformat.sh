...
mkdir -p /datadisk1
/usr/local/bin/safe_format_and_mount.sh -m "mkfs.ext4 -m 0 -F -E stripe-width=256,lazy_itable_init=0,lazy_journal_init=0,discard" /dev/sdb /datadisk1
umount /datadisk1
...
# disk 2
mkdir -p /datadisk2
/usr/local/bin/safe_format_and_mount.sh -m "mkfs.ext4 -m 0 -F -E stripe-width=256,lazy_itable_init=0,lazy_journal_init=0,discard" /dev/sdc /datadisk2
umount /datadisk2
