...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "db" do |db|
    ...
    db.vm.provision "shell", :inline => localscriptDir + "/apt-get.upgrade.sh"
    ...
    db.vm.provision "shell" do |s|
      ...
      s.inline = localscriptDir + "/install_vagrant.sh"
    end
  ...
  config.vm.define "haproxy" do |haproxy|
    ...
    haproxy.vm.provision "shell", :inline => localscriptDir + "/apt-get.upgrade.sh"
